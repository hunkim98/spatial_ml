...
export interface PDFClipperEditorComponentHandle {
...
interface PDFClipperEditorComponentProps {
  pdfUrl: string;
  pageNumber: number;
  initialClipRect?: { x: number; y: number; width: number; height: number };
}

export const PDFClipperEditorComponent = forwardRef<
  PDFClipperEditorComponentHandle,
  PDFClipperEditorComponentProps
